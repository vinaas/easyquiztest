                ...
                <div class="ui three column grid">
                    <div class="four wide column">
                        <!--<div class="row" style="padding-bottom:10px">
                            <button v-on:click="endQuizTest" class="positive ui button fluid">thi BAO</button>
                        </div> -->
                        <router-link class="item header item" to="/quiz"> 
                        <div class="row" style="padding-bottom:10px">
                            <button class="positive ui button fluid">thi BAO 123</button>
                        </div>  
                        </router-link>
                        <div class="row">
                            <div class="ui card">
